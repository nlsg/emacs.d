...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-filter" '("telega-" "tracking-buffers")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-match" '("and" "call" "chat-" "define-telega-matcher" "ids" "msg-" "not" "prop" "return" "sender-" "telega-" "user-")))
